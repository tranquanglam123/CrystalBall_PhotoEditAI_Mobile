...
public class TabIndicator extends HorizontalScrollView implements Animator.AnimatorListener {
    ...
    private void addTab(int index, int width, String title) {
        ...
        tabsContainer.addView(tabView, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.MATCH_PARENT));
    }
    ...
    private void addNavButton(int index, int direction) {
        ...
        tabsContainer.addView(navButton, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.MATCH_PARENT));
    }
    ...
    private class TabView extends android.support.v7.widget.AppCompatButton {
    ...
    private class NavButton extends android.support.v7.widget.AppCompatImageButton {
