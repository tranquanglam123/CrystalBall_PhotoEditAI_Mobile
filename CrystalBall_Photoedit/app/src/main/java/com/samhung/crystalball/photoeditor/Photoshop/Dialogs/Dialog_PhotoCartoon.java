...
public class Dialog_PhotoCartoon extends FullScreenDialog implements View.OnTouchListener{
    ...
    public Dialog_PhotoCartoon(Context context , Bitmap bitmap, OnClickListener onClickListener) {
        super(context);
        mContext = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_photo_cartoon);
    ...
    View.OnClickListener btnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if(v.getId() == R.id.button_accept)
                m_onClickListener.onClick(Dialog_PhotoCartoon.this, DialogInterface.BUTTON_POSITIVE);
            else if(v.getId() == R.id.button_close)
                m_onClickListener.onClick(Dialog_PhotoCartoon.this, BUTTON_NEGATIVE);
        }
    };
    ...
    public class AsyncTask_ProcessEffect extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            mResultBitmap = Engine.getIntance().ImageCartoon(mBitmap, prog);
            return null;
        }
