...
public class EmoticonAdapter extends RecyclerView.Adapter<EmoticonAdapter.ViewHolder> {
    ...
    public EmoticonAdapter(@NonNull Context context, @NonNull List<Bitmap> imageBitmaps) {
...
//                        onImageClickListener.onImageClickListener(decodeSampledBitmapFromAssets(getAdapterPosition()), getAdapterPosition());
                    onImageClickListener.onImageClickListener(imageBitmaps.get(getAdapterPosition()), getAdapterPosition());
