package com.samhung.crystalball.photoeditor.Utilis.zipfile;
/*
...
public class APKExpansionSupport {
	...
	private final static String EXP_PATH = "/나의길동무/프로그람"; //"/Android/obb";
...
//					String strMainPath = expPath + File.separator + "main." + mainVersion + "." + packageName + ".obb";
					String strMainPath = expPath + File.separator + "수정구슬.obb";
