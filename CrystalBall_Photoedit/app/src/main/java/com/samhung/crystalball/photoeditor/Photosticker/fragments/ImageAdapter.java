...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public Bitmap decodeSampledBitmapFromAssets(int resId) {
        String strfileName = String.format("sticker/%d/src.png", resId + 1);
        Bitmap ret=null;
        try {
    ...
    public Bitmap decodeSampledBitmapFromOBB(int resId) {
        String strfileName = String.format("assets/sticker/%d/src.png", resId + 1);
        Bitmap ret=null;
        try {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onImageClickListener != null)
                        onImageClickListener.onImageClickListener(decodeSampledBitmapFromOBB(getAdapterPosition()), getAdapterPosition());
//                    onImageClickListener.onImageClickListener(imageBitmaps.get(getAdapterPosition()));
    ...
    public interface OnImageClickListener {
        void onImageClickListener(Bitmap image, int imageIndex);
    }
}
