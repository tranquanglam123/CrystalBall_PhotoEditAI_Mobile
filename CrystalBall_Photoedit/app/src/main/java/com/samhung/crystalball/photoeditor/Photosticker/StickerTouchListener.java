...
public class StickerTouchListener implements View.OnTouchListener {
    ...
    public StickerTouchListener(boolean rotateEnabled) {
        isRotateEnabled = rotateEnabled;
        mScaleGestureDetector = new ScaleGestureDetector(new ScaleGestureListener());
    }

    public StickerTouchListener(int parentWidth, int parentHeight) {
        this(true);
...
//        view.setRotation(rotation);
    ...
    private void moveCorrectPosition(View view)
    {
      ...
      //  float displayHeight = dm.heightPixels - MeasureUtil.convertDpToPixels(50, view.getContext());
        float displayWidth = parentWidth;
        float displayHeight = parentHeight;
